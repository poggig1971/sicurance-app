...
st.set_page_config(page_title="TESTING SicurANCE Piemonte e Valle d'Aosta", layout="centered")
...
with col2:
    st.markdown("""
        <h1 style='font-size: 24px; margin-bottom: 5px;'> TESTING SicurANCE Piemonte e Valle d'Aosta</h1>
...
# Upload immagine
uploaded_file = st.file_uploader("📷 Carica una foto che riprenda il cantiere nella suo insieme, senza inquadrare direttamente una persona", type=["jpg", "jpeg", "png"])
...
with st.form("note_form"):
    note = st.text_area("località o Note aggiuntive (facoltative)", placeholder="Scrivi qui eventuali note...", height=100)
