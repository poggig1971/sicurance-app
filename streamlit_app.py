                            ...
                            "content": [
                                {
                                    "type": "text",
                                    "text": (
                                    "Analizza questa immagine come esperto di sicurezza nei cantieri secondo il D.Lgs. 81/2008. Non devi in alcun modo identificare persone, volti o soggetti specifici. Verifica solamente se: - sono presenti e correttamente utilizzati i dispositivi di protezione individuale (caschi, guanti, occhiali, scarpe antinfortunistiche, imbracature), specificando se ciascun DPI è indossato in modo conforme all’Art. 77, comma 4, lettera a), e all’Allegato VIII del D.Lgs. 81/2008 (es. casco correttamente posizionato e allacciato); - l’ambiente è conforme alle norme di sicurezza in relazione a: ponteggi, parapetti, segnaletica, recinzioni, carichi sospesi, rischio elettrico o meccanico, rischio di scivolamento o caduta, illuminazione e visibilità; - i comportamenti operativi osservabili sono compatibili con la normativa sulla sicurezza e coerenti con le misure di prevenzione previste in un cantiere. Fornisci una valutazione dettagliata delle eventuali criticità tecniche osservabili, con riferimento agli articoli del D.Lgs. 81/2008, indicando possibili azioni correttive. Evita qualsiasi commento su chi o cosa appare nell’immagine."
                                )                                },
                                {
                                    "type": "image_url",
                                    "image_url": {
